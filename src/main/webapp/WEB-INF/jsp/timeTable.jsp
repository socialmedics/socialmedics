...
<div class="container">
    <div class="my-5 border-bottom">
        <h1>Horarios de atenci&oacute;n <small>Dr. <%= ((Medics) request.getAttribute("medic")).getName() %> <%= ((Medics) request.getAttribute("medic")).getSurname() %></small></h1>
    </div>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><%= timeTable.getWeekday() %></td>
                    <td><%= timeTable.getTimeStart().toString().substring(0, timeTable.getTimeStart().toString().length() - 3) %></td>
                    <td><%= timeTable.getTimeEnd().toString().substring(0, timeTable.getTimeEnd().toString().length() - 3) %></td>
                    <td>
                        <a id="timetable-delete" href="/timetable/delete/<%= timeTable.getId() %>" class="btn btn-danger">X</a>
                    </td>
                </tr>
                <% } %>
            </tbody>
